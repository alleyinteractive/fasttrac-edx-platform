...
MANDRILL_API_KEY = ENV_TOKENS.get('MANDRILL_API_KEY')
...
# Enable user migration to auth0 on login:
MIGRATE_TO_AUTH0 = ENV_TOKENS.get('MIGRATE_TO_AUTH0', False)

# MailChimp interest IDs
ENTREPRENEUR_MAILCHIMP_INTEREST_ID = ENV_TOKENS.get('ENTREPRENEUR_MAILCHIMP_INTEREST_ID', '83d6404c2e')
AFFILIATE_MAILCHIMP_INTEREST_ID = ENV_TOKENS.get('AFFILIATE_MAILCHIMP_INTEREST_ID', 'f6cdcb8e7b')

WORKSPACE_API_KEY = ENV_TOKENS.get('WORKSPACE_API_KEY', 'workspace_api_key')
SLACK_WEBHOOK_URL = ENV_TOKENS.get('SLACK_WEBHOOK_URL')
